          ...
          <Container>
            <div className="row align-items-center">
              <div className="col-lg-6">
                <h2 className="mb-4">About ResumeMate</h2>
                ...
                <div className="mt-4">
                  ...
                  <ul className="list-unstyled">
                    <li className="mb-3">
                      ✓ Explore Premium Resume Templates for a Professional
                      and Polished Look
                    </li>
              ...
              <div className="col-lg-6">
                ...
                <div className="team-members">
                  <div className="team-member mb-3">
                    <h5 className="mb-1">Kunal Kumar Gupta</h5>
                    <p className="mb-2">Full Stack Developer</p>
                    <a
                      href="https://www.linkedin.com/in/kunal-gupta-4592032bb"
                  ...
                  <div className="team-member mb-3">
                    <h5 className="mb-1">Adarsh Kumar</h5>
                    <p className="mb-2">Full Stack Developer</p>
                    <a
                      href="https://www.linkedin.com/in/adarshkumar-cse/"
                      className="btn btn-outline-light btn-sm"
                    >
                      LinkedIn Profile
                    </a>
                  ...
                  <div className="team-member mb-3">
                    <h5 className="mb-1">Ankur Singh</h5>
                    <p className="mb-2">Full Stack Developer</p>
                    <a
                  ...
                  <div className="team-member mb-3">
                    <h5 className="mb-1">Vivek Pratap</h5>
